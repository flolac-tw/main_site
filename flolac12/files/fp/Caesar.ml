...
let count p = undefined ()

let count_eq x = undefined ()

let count_lower xs = undefined ()
...
let rotate n xs = undefined ()

let index xs = undefined ()

let positions x xs = undefined ()
...
let crack xs = undefined ()
 
let decode xs = undefined ()
